"""
0_build_instances.py
Convert rcsr_processed.json (bundle-based) into flat single-context rows.
Each (question, mode_bundle) becomes one independent instance.
Output: instances_{train,val,test}.jsonl  +  label_policy.json
"""
import json
